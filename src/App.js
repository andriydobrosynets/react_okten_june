import './components/simpson/Simpson'
import './main.css';
...
function App() {
  return (
    <div className={'main'}>
        <div><Simpson i={0} simpsons={simpsons}/></div>
        <div><Simpson i={1} simpsons={simpsons}/></div>
        <div><Simpson i={2} simpsons={simpsons}/></div>
        <div><Simpson i={3} simpsons={simpsons}/></div>
        <div><Simpson i={4} simpsons={simpsons}/></div>
    </div>
  );
}
